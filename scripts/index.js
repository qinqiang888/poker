window.onload=function(){
    ...
    // if(els[i].innerHTML==K){show.removeChild();}
    // if(els[i].innerHTML==J){first==11;}
    // if(els[i].innerHTML==A){first==1;}
    // if(els[i].innerHTML==Q){first==12;}
    
    // first=els[i].innerHTML;
